...
library(rblimp)
library(readr)
rblimp::set_blimp("E:/Program Files/Blimp/blimp.exe")
source("H:/My Drive/Stefan/EMA R37/Missing values in EMA paper/Missing values paper outline 2025/for GITHUB/EMAuxiliary.R")  
#source("https://raw.githubusercontent.com/schneids111/EMAuxiliary/main/EMAuxiliary.R")

setwd("H:/My Drive/Stefan/EMA R37/Missing values in EMA paper/Missing values paper outline 2025/R&R/Files for empirical study")

data_path <- "H:/My Drive/Stefan/EMA R37/Missing values in EMA paper/Missing values paper outline 2025/R&R/Files for empirical study"
data1 <- read_csv(file.path(data_path, "study_data.csv"))
output_path <- "H:/My Drive/Stefan/EMA R37/Missing values in EMA paper/Missing values paper outline 2025/R&R/Files for empirical study"
